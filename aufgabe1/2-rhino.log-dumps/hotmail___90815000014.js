...
if (loc=="InBox")
ret='<A HREF="JavaScript:MIM(%22' + eM + '%22)"><IMG alt="" src="http://64.4.48.24/icon_messenger'+img+'.gif" border=0></a>';
else if (loc=="AddressBookList")
{
if (CS==1)
ret='&nbsp;&nbsp;&nbsp;<A href="#" onclick="DC();return false;"><IMG alt="" src="http://64.4.48.24/icon_messenger'+img+'.gif" border=0></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
else
ret='&nbsp;&nbsp;&nbsp;<A HREF="JavaScript:MIM(%22' + eM + '%22)"><IMG alt="" src="http://64.4.48.24/icon_messenger'+img+'.gif" border=0></a>&nbsp;&nbsp;&nbsp;&nbsp;';
}
return ret;
...
DC.onmouseover=OMO;
DC.onmouseout=OMOU;
DC.innerHTML='<img src="http://64.4.48.24/i.p.instantreply.gif" border=0 align="absmiddle" hspace="1"> Instant Reply';
}
}
function IR()
...
{
qF=H;
document.ToInd.src = document.CcInd.src = document.BccInd.src = 'http://64.4.48.24/spacer.gif';
if (H=="to")
document.ToInd.src = 'http://64.4.48.24/i.p.toarrow.gif';
if (H=="cc")
document.CcInd.src ='http://64.4.48.24/i.p.toarrow.gif';
if (H=="bcc")
document.BccInd.src = 'http://64.4.48.24/i.p.toarrow.gif';
}
function MIT(qaName){
...
NotBulkButton.children[0].src="http://64.4.48.24/i.p.notjunk.d.gif";
...
NotBulkButton.children[0].src="http://64.4.48.24/i.p.notjunk.gif";
...
NotBulkButton.children[0].src=(TO>1)?"http://64.4.48.24/i.p.notjunk.d.gif":"http://64.4.48.24/i.p.notjunk.gif";
